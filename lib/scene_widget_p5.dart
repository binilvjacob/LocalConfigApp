...
class Scene_p5 extends StatefulWidget {
  final int sceneNo;

  Scene_p5(this.sceneNo);
  @override
  _Scene_p5State createState() => _Scene_p5State();
}

class _Scene_p5State extends State<Scene_p5> {
  @override
  void dispose() {
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<bool>(
        valueListenable: s5.sceneController,
          ...
          return GestureDetector(
            child: Opacity(
              ...
              child: ArgonTimerButton(
                ...
                color: s5.sceneBorderColor[widget.sceneNo],
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    image: AssetImage(s5.sceneImages[widget.sceneNo]),
