...
class Scene_p4 extends StatefulWidget {
  final int sceneNo;

  Scene_p4(this.sceneNo);
  @override
  _Scene_p4State createState() => _Scene_p4State();
}

class _Scene_p4State extends State<Scene_p4> {
  @override
  void dispose() {
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<bool>(
        valueListenable: s4.sceneController,
          ...
          return GestureDetector(
            child: Opacity(
              ...
              child: ArgonTimerButton(
                ...
                color: s4.sceneBorderColor[widget.sceneNo],
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    image: AssetImage(s4.sceneImages[widget.sceneNo]),
