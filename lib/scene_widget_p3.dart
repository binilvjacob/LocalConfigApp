...
class Scene_p3 extends StatefulWidget {
  final int sceneNo;

  Scene_p3(this.sceneNo);
  @override
  _Scene_p3State createState() => _Scene_p3State();
}

class _Scene_p3State extends State<Scene_p3> {
  @override
  void dispose() {
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<bool>(
        valueListenable: s3.sceneController,
          ...
          return GestureDetector(
            child: Opacity(
              ...
              child: ArgonTimerButton(
                ...
                color: s3.sceneBorderColor[widget.sceneNo],
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    image: AssetImage(s3.sceneImages[widget.sceneNo]),
