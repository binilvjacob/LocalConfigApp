...
/// Change PAGE
class Scene_p8 extends StatefulWidget {
  final int sceneNo;

  Scene_p8(this.sceneNo);
  @override
  _Scene_p8State createState() => _Scene_p8State();
}

/// Change PAGE
class _Scene_p8State extends State<Scene_p8> {
  @override
  void dispose() {
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<bool>(
        ...
        /// Change PAGE
        valueListenable: s8.sceneController,
          ...
          return GestureDetector(
            child: Opacity(
              ...
              child: ArgonTimerButton(
                ...
                /// Change PAGE
                color: s8.sceneBorderColor[widget.sceneNo],
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    /// Change PAGE
                    image: AssetImage(s8.sceneImages[widget.sceneNo]),
