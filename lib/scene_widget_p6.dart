...
/// Change PAGE
class Scene_p6 extends StatefulWidget {
  final int sceneNo;

  Scene_p6(this.sceneNo);
  @override
  _Scene_p6State createState() => _Scene_p6State();
}

/// Change PAGE
class _Scene_p6State extends State<Scene_p6> {
  @override
  void dispose() {
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<bool>(
        ...
        /// Change PAGE
        valueListenable: s6.sceneController,
          ...
          return GestureDetector(
            child: Opacity(
              ...
              child: ArgonTimerButton(
                ...
                /// Change PAGE
                color: s6.sceneBorderColor[widget.sceneNo],
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    /// Change PAGE
                    image: AssetImage(s6.sceneImages[widget.sceneNo]),
